> Arsip snapshot pada 6 Agustus 2026. File ini dipertahankan untuk histori dan
> bukti lama; jangan gunakan sebagai status terbaru atau konteks bootstrap.
> Kutipan sensitif atau berpotensi mengidentifikasi diparafrase untuk menjaga
> privasi; fakta defect dan hasil operasional tetap dipertahankan.
...
tes, tetapi **belum satu pun diuji ulang lewat Telegram**. Kutipan pengguna
direduksi; kelas kegagalan ketika dua model sama-sama salah menilai tetap
terbuka:

1. Balasan tentang identitas model terdengar jutek karena aturan anti-pola
   terlalu keras.
2. Curhat sembilan paragraf dijawab satu kalimat.
3. Saran waktu bertentangan dengan jam lokal malam itu.
4. Pesan pertama dibalas seolah percakapan lama sudah ada.
5. **Informasi orientasi seksual tersimpan otomatis tanpa izin.** Pagar sensitif
   gagal mengenali variasi morfologi dan kosakata. Ini pelanggaran Pasal 4 nomor
   3, dan kelas cacat yang sama pernah muncul dengan susunan berbeda.
6. Rujukan ambigu ke pesan sebelumnya membuka seluruh daftar memori; kontrol
   penghapusan kemudian digunakan dan seluruh riwayat hilang.
7. Permintaan pengingat tanpa isi konkret tersimpan sebagai tugas generik tanpa
   tenggat meski Harvy sedang meminta detail.
8. Tombol penjelasan consent tetap aktif setelah dipakai sehingga penjelasan
   terkirim dua kali.
9. Naskah statis terpenggal di tengah kalimat karena line wrapping ganda.
10. Catatan memori menyebut pemiliknya sebagai orang ketiga pada UI sendiri.

Pertanyaan gaya juga muncul terlalu dini setelah pesan pembuka minimal.
...
- pencatatan tugas dari kalimat natural, lengkap dengan pengingat pada jadwal
  spesifik, tercatat benar berikut 🔔;
- **tombol inline benar-benar hidup.** Tombol Selesai ditekan dan bekerja, yang
  sekaligus membuktikan perbaikan `allowed_updates`;
- tutoring satu giliran dijawab dengan memecah topik dan bertanya balik, bukan
...
- balasan referensial pendek tertahan sekitar sepuluh menit ketika pemadatan
