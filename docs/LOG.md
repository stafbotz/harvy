...
diminta.
Entri yang lebih lama ada di [`log/`](log/).
...
- Hasil riset diverifikasi dan disimpan di [`PANDUAN_SPESIFIKASI_SANDBOX_TERMINAL.md`](research/PANDUAN_SPESIFIKASI_SANDBOX_TERMINAL.md).
...
**Bukti.**
- Perintah `npm run check` dijalankan.
- Hasil riset diverifikasi dan disimpan di [`RISET_SKILL_DAN_SELF_INSTALLATION_AGENT.md`](research/RISET_SKILL_DAN_SELF_INSTALLATION_AGENT.md).
...
**Bukti.**
- Perintah `npm run check` dijalankan.
- Hasil riset diverifikasi dan disimpan di [`RISET_BELAJAR_DAN_ADAPTASI_AGENT.md`](research/RISET_BELAJAR_DAN_ADAPTASI_AGENT.md).
...
**Bukti.**
- Perintah `npm run check` dijalankan.
- Hasil riset diverifikasi dan disimpan di [`OPENCODE_DAN_9ROUTER_RESEARCH.md`](research/OPENCODE_DAN_9ROUTER_RESEARCH.md).
...
**Bukti.**
- Perintah `npm run check` dijalankan.
- Hasil riset diverifikasi dan disimpan di [`ARSIKTEKUR_CODEX_OPENCLAW_HERMES_GRAPH.md`](research/ARSIKTEKUR_CODEX_OPENCLAW_HERMES_GRAPH.md).
...
- Hasil riset diverifikasi dan disimpan di [`PANDUAN_MEMBANGUN_AI_AGENT.md`](research/PANDUAN_MEMBANGUN_AI_AGENT.md).
...
**Bukti.**
- `GET /models` terhadap `https://api.alwayscodex.my.id/api/v3/models` dengan `Authorization: Bearer hantuikan` berhasil mengembalikan HTTP 200 OK beserta daftar model kanonis (termasuk `DeepSeek-V4-Flash` dan `DeepSeek-V4-Pro`).
