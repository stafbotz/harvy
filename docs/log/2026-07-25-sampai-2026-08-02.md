# Catatan Pekerjaan Harvy — Arsip

Entri lama dari `docs/LOG.md`. Entri terbaru ada di [`LOG.md`](../LOG.md).
...
melaporkan bahwa percakapan terasa jutek, tidak proaktif, tidak memahami, dan
berhalusinasi. Kutipan transkrip pengguna diparafrase untuk privasi.

**Yang ditemukan.** Sepuluh cacat, dua di antaranya serius.

1. **Informasi orientasi seksual tersimpan otomatis tanpa izin.** Pagar
   sensitif gagal mengenali variasi morfologi dan kosakata. Ini pelanggaran
   Pasal 4 nomor 3 dan bentuk kedua dari kelas cacat yang sama.
2. **Rujukan ambigu ke pesan sebelumnya membuka seluruh daftar memori** berikut
   kontrol penghapusan menyeluruh. Kontrol itu kemudian digunakan dan seluruh
   riwayat hilang; salah baca berada satu langkah dari penghapusan permanen.
3. Balasan identitas model terdengar jutek karena aturan anti-pola yang ditulis
   sehari sebelumnya terlalu keras.
4. Curhat sembilan paragraf tentang beberapa area hidup dijawab satu kalimat.
5. Harvy memberi saran waktu yang bertentangan dengan jam lokal malam itu.
6. Pesan pertama dijawab seolah percakapan lama sudah ada.
7. Permintaan pengingat tanpa isi konkret tersimpan sebagai tugas generik tanpa
   tenggat, padahal Harvy sedang menanyakan detailnya.
8. Tombol penjelasan consent tetap hidup setelah ditekan; penjelasan
   persetujuan terkirim dua kali.
9. Naskah statis terpenggal karena line wrapping ganda.
10. Catatan memori menyebut pemiliknya sebagai orang ketiga pada UI sendiri.

Pertanyaan gaya juga muncul tepat setelah pesan pembuka minimal.
