...
export function consentDetail(
  ...
  return [
    ...
    "• Setelah kamu memilih mulai, aku dapat otomatis menyimpan beberapa catatan yang berguna tentangmu—termasuk hal pribadi—biar kamu nggak perlu mengulang cerita. Penilaian AI bisa keliru saat memilih apa yang berguna diingat. Setiap penyimpanan atau perubahan yang benar-benar berhasil akan kusebutkan secara natural dalam balasanku; itu pemberitahuan, bukan permintaan izin baru, dan tidak disertai tombol per item. Kamu bisa langsung mengoreksi atau menyuruhku lupa dengan bahasa biasa, atau membuka /memori untuk melihat dan mengendalikan semuanya. Password, OTP, PIN, token, API key, dan credential sejenis tidak pernah kujadikan memori.",
