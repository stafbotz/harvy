...
export function understandingPrompt(now: Date, timeZone: string): string {
  ...
  return [
    ...
    "  cerita romantis, kesehatan, keluarga, dan hal pribadi tanpa bukti bahaya.",
    '- level possible untuk sinyal risiko yang ambigu atau tekanan akut yang',
    "  perlu triase khusus; strong hanya untuk bukti jelas tentang self-harm,",
    ...
    '   "needsStepByStep":false,"task":null,',
    '   "memories":[]}',
