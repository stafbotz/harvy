...
export function understandingPrompt(now: Date, timeZone: string): string {
  ...
  return [
    ...
    "- Seluruh mutasi project, goal, dan skill wajib explicit dengan evidence dari pesan kini.",
    "",
    ...
    "- toolNeed none bila analisis, urutan prioritas, rencana, strategi, atau eksperimen dapat langsung dijawab di chat.",
    "- toolNeed internal_state bila jawabannya menuntut membaca state Harvy: daftar tugas, agenda, sesi, pengingat, waktu, atau pengaturan pengguna. Menebak state itu tanpa membacanya tidak sah.",
