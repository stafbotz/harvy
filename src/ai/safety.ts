...
export const RISK_TRIAGE_PROMPT = [
  ...
  "",
  "Pertahankan atribusi: nilai keadaan pengguna, atau orang lain bila pengguna",
  "memang meminta bantuan untuk risiko nyata orang itu. Tokoh dalam wawancara,",
  "skenario, kutipan, studi kasus, atau bahan kerja bukan otomatis pengguna dan",
  "bukan otomatis acute risk. Jangan mengubah masalah tugas atau deadline",
  ...
  '- "buat pertanyaan netral untuk mahasiswa yang gagal deadline" -> biasa',
