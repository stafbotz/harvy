...
export const EPISODE_SUMMARY_PROMPT = [
  ...
  "",
  "Keluarkan satu objek JSON dengan tepat sepuluh array ini:",
  '{"topics":[],"facts":[],"goals":[],"decisions":[],"corrections":[],',
  '"commitments":[],"unresolved":[],"progress":[],"temporalAnchors":[],',
  '"uncertainties":[]}',
  ...
  "- progress hanya untuk hal yang penggunanya berhasil kerjakan, pahami, atau",
  "  selesaikan sendiri, dan hanya bila sumber menyatakannya. Bukan pujian,",
  "  bukan penilaian kemampuan, dan bukan pekerjaan yang Harvy yang",
  "  mengerjakannya. \"Akhirnya bisa nurunin rumusnya sendiri\" masuk;",
  "  \"Harvy menjelaskan turunan\" tidak.",
  ...
  "  mengeluarkan sepuluh array kosong bila salah satunya ada di sumber.",
  ...
  "- Bila tidak ada yang perlu dipertahankan, keluarkan sepuluh array kosong.",
