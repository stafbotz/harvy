...
export const GROUP_NOTICE_VERSION = 11;
export function groupNotice(operationalLogRetentionDays = 14): string {
  return [
    "Halo, aku Harvy—AI yang ikut ngobrol sebagai anggota grup ini. Pesan live yang memicu pemberitahuan ini akan kuproses setelah pemberitahuan terkirim; sesudahnya, pesan baru di grup dapat diproses oleh satu layanan model AI utama pihak ketiga supaya aku bisa memahami konteks dan tahu kapan perlu nimbrung. Harvy tidak mengirim ulang permintaan itu ke penyedia cadangan. Layanan utama dapat otomatis memakai ulang bagian awal prompt yang berulang melalui cache penyedia; Harvy tidak mengirim perintah cache-write khusus dan hanya mencatat hitungan token cache tanpa isi. Aku tidak membaca riwayat dari sebelum aku hadir, dan gambar grup belum diproses.",
    "",
